...
def strategy_text(name):
    ...
    if name=='vpd':
        ...
        return (f'📊 VPD · 상위 후보 분산 모의투자\n\n'
                ...
                '운용 시간\n07:30에 아침 자료로 준비하고, 09시 이후 당일에는 리밸런싱을 다시 요청해 전일 확정 자료로 재점검할 수 있습니다. 확정 자료가 없으면 새 스캔을 만든 뒤 요청한 리밸런싱을 이어서 실행합니다. 같은 확정 자료를 다시 요청해도 매매를 반복하지 않습니다. 스캔 중에도 익절·손절·수익 보호 모니터는 계속 작동합니다.\n\n'
