...
def strategy_text(name):
    ...
    if name=='fast':
        return ('⚡ FAST · 짧은 보유시간 모의투자\n\n'
                ...
                '1분마다 최근 완결 5분 가격 +1% 이상, 직전 5분보다 상승폭 확대, 체결 거래대금 2배 이상을 검사합니다. '
                '가격 상승 상위 최대 20종목을 상세 확인하며 같은 종목 재포착 간격은 10분입니다. '
                '조건 충족마다 회당 20만원, 거래소당 최대 5종목에 모의 진입합니다. '
                ...
                '최소 호가 차이·스프레드는 후보·진입 제외 조건에서 빼고, 실제 매수 ask·매도 bid 호가 깊이에 가정 수수료·추가 슬리피지로 반영합니다. '
