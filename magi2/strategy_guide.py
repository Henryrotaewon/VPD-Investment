...
def strategy_text(name):
    ...
    if name=='fast':
        return ('⚡ FAST · 10분 1틱 반복 모의투자\n\n'
                ...
                '최근 완결 5분 가격 +1% 이상, 직전 5분보다 상승폭 확대, 거래대금 2배 이상인 종목을 1분마다 포착합니다. '
                '최소 호가 차이는 포착 제외 조건으로 사용하지 않습니다.\n\n'
                '포착 후 현재가−1틱에 지정가 매수 → 매수 체결 직후 현재가+1틱에 지정가 매도 → 매도 완료 후 다시 매수합니다. '
                ...
                '원금·기존 이력·해외 고정 환산율은 유지합니다. 기존 5분 보유 결과와 v3 반복매매 결과를 구분합니다. '
                '실시간 PAPER · 실제 주문 없음.')
    if name=='wave':
