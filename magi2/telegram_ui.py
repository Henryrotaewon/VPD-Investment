...
LABELS = {
    ...
    '🧪 shadows 모의투자': 'shadows', 'FAST 모의투자': 'fast',
    '🧭 시장 국면': 'regime',
...
def role_text():
    return ('🧩 MAGI — 시장 관측 · 전략 검증 · 실행 관리\n\n'
            ...
            'FAST는 거래소별 최초 100만원으로 전일종가 대비 TOP 5 모의투자를 수행합니다. +12% 익절, TOP 5 이탈 및 −6% 동시 충족 시 손절합니다.\n\n'
...
def validation_text():
    return ('🧭 전략검증\n전략별 설명·매매 공략과 검증 진행 상황을 확인하세요. WAVE는 실제 관측 및 시간 이동 대조군 분석으로 연결됩니다.\n\n'
            ...
            '📊 VPD: 상위 후보 분산 모의투자\n'
            '⚡ FAST: 전일종가 대비 TOP 5·5분 갱신·+12% 익절·TOP 5 이탈 및 −6% 손절\n\n'
